...
namespace Platform.Payment.PaymentProcessor
{
    public static class AuthorizeProcessor
    {
        ...
        public static PaymentResponse GetAuthorizationResponseInfo(string pfResponse, PaymentResponse errInfo)
        {
        ...
        public static PaymentResponse VoidAuthorize(string jsonRequest, string url, PaymentResponse errInfo)
        {
            ...
            {
                return GetPayfortExceptionResponseInfo(errInfo, PaymentCommandType.VOID_AUTHORIZATION);
            }
        }
